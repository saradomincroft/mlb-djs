...
def add_dj():
    ...
    while True:
        genre_title = input(f"Enter music genre for {name}: ").title()
        ...
        # Add subgenres
        while True:
            subgenre_title = input(f"Enter Subgenre of {mapped_genre_title} for {name}: ").title()
    ...
    while True:
        venue_name = input(f"Enter a venue for {name}: ").title()
